...
class UserTest < ActiveSupport::TestCase
	...
	test "active_user_uniqueness" do
		...
		# If there is no active user, is the same email user saved?
		count = 3
		...
		# If an active user disappears, is the same email user preserved?
		active_user.destroy!
		assert_difference("User.count", 1) do
